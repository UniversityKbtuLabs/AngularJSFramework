	...
	var param = {
		...
		"Param": {
			"PKCS10":{
				...
				"altOther":options.PKCS10.altOther,
...
function getPemFormat(options, callback){
	var param = {
		"TumarCSP": "BaseAPI",
		"Function": "getPemFormat",
		"Param": {
			"id":options.id,
			"profile":options.profile,
			"pass":options.pass,
...
var getPemFormatReturn={};
function ChangePasswd(options, callback){
	var param = {
		"TumarCSP": "BaseAPI",
...
var ChangePasswdReturn={};
function exportDataToFile(options, callback){
	var param = {
		"TumarCSP": "BaseAPI",
...
var exportDataToFileReturn={};
function waitForCardPresent(options, callback){
	var param = {
		"TumarCSP": "BaseAPI",
		"Function": "waitForCardPresent",
		"Param": {
			"":timeout,
			"id":options.id,
			"":reader,
...
function InstallFingerprintTokenAndSign(options, callback){
	var param = {
		"TumarCSP": "SYSAPI",
		"Function": "InstallFingerprintTokenAndSign",
		"Param": {
...
var InstallFingerprintTokenAndSignReturn={};
function ListFingerprintFromToken(options, callback){
	var param = {
		"TumarCSP": "SYSAPI",
		"Function": "ListFingerprintFromToken",
		"Param": {
			"timeout":options.timeout,
			"viewdlg":options.viewdlg,
			"device":options.device,
...
var ListFingerprintFromTokenReturn={};
function CheckFingerprintAndSignFromToken(options, callback){
	var param = {
		"TumarCSP": "SYSAPI",
		"Function": "CheckFingerprintAndSignFromToken",
		"Param": {
			"timeout":options.timeout,
			"viewdlg":options.viewdlg,
			"device":options.device,
...
var CheckFingerprintAndSignFromTokenReturn={};
function GetEnvironment(options, callback){
	var param = {
		"TumarCSP": "SYSAPI",
		"Function": "GetEnvironment",
		"Param": {
			"id":options.id,
			"nameEnv":options.nameEnv,
		}
	};
	if (!isConnect) {
		errorConnectCallBack("CryptoSocket not avaible");
...
function SignCMS(options, callback){
	var param = {
		"TumarCSP": "ASNAPI",
		"Function": "SignCMS",
		"Param": {
...
var ShowSaveDialogReturn={};
function SubscribeConnect(options, callback){
	var param = {
		"TumarCSP": "AsyncAPI",
...
var SubscribeConnectReturn={};
function SubscribeDisconnect(options, callback){
	var param = {
		"TumarCSP": "AsyncAPI",
...
var SubscribeDisconnectReturn={};
function CheckSubscribe(options, callback){
	var param = {
		"TumarCSP": "AsyncAPI",
